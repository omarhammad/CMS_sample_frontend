...
function showToast(message) {
    ...
    let toast = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Toast(toastElement, {
        autohide: false
    });
    toast.show();
...
submit_btn.addEventListener('click', async (event) => {
    ...
    try {
        ...
        if (response.status === _common_js__WEBPACK_IMPORTED_MODULE_0__.HttpStatus.OK) {
            const doctor_name = data.firstName + ' ' + data.lastName;
            (0,_common_js__WEBPACK_IMPORTED_MODULE_0__.showToast)(`Dr. ${doctor_name} added!`);
        } else if (response.status === _common_js__WEBPACK_IMPORTED_MODULE_0__.HttpStatus.BAD_REQUEST) {
            if (data.hasOwnProperty('exceptionMsg')) {
                (0,_common_js__WEBPACK_IMPORTED_MODULE_0__.showToast)(data.exceptionMsg);
            } else {
        ...
        console.error(error);
        (0,_common_js__WEBPACK_IMPORTED_MODULE_0__.showToast)('An error occurred while adding the doctor.');
    }
});
...
/***/ "./src/js/doctors/search_doctor.js":
/*!*****************************************!*\
  !*** ./src/js/doctors/search_doctor.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _js_doctors_add_doctor_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/doctors/add_doctor.js */ "./src/js/doctors/add_doctor.js");
/* harmony import */ var _js_doctors_search_doctor_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/doctors/search_doctor.js */ "./src/js/doctors/search_doctor.js");
